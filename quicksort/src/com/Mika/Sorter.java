 ...
 * @author Mika
 *
 * this code is a implementation of the version found on https://github.com/knpwrs/Multi-Threaded-In-Place-QuickSort/blob/master/src/main/java/net/kenpowers/projects/quicksort
 */
...
public class Sorter {
     ...
     */
    public static int N_THREADS = 2;

    public Sorter(int threads){
        N_THREADS = threads;
